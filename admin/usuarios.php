...
<div class="modal fade" id="empleados" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered " role="document">
            <div class="modal-content ">
                <div class="modal-header">
                    <h3 class="mx-5 section-heading text-uppercase ">Nuevo Colaborador</h3>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body ">
                <h6 class="mx-5 section-heading text ">Los campos en rojo son obligatorios</h6>
                        ...
                        <form class="was-validated">
                            ...
                            <div class=" row no-guters ">
                                ...
                                <div class="col-md-12 mb-2 mx-5">
                                    ...
                                    <div class="input-group col-md-9">
                                        <input type="number" id="documentoColaborador" class="form-control  " placeholder="Documento" required>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-2 mx-5">
                                ...
                                <div class="col-md-12 mb-2 mx-5">
                                    ...
                                    <div class="input-group col-md-9">
                                        <input type="text" id="psw" class="form-control  " placeholder="Contraseña" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class=" row no-guters">
                                ...
                                <div class=" col-md-10 mb-2">
                                    ...
                                    <button id="agregarColaborador" type="button"
