...
<!------------------------------------------------------- Tabla ------------------------------------------------------------> 
            ...
            <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div  id="tabla_registro_matrimonio" class="table-responsive">                                
                            </div>
                        </div>
            </div>
            <!------------------------------------------------ Mas Datos Facturas -------------------------------------------->  
                        ...
                        <form class="was-validated">
                            ...
                            <div class=" row no-guters ">
                                ...
                                <div class="col-md-12 mb-2 my-2 mx-5">
                                    <div class="input-group col-md-9">
                                        <input type="text" id="reg_matri_nombrenovio" class="form-control  " placeholder="Nombre novio" required>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-2 my-2 mx-5">
                                    <div class="input-group col-md-9">
                                        <input type="text" id="reg_matri_nombrenovia" class="form-control  " placeholder="Nombre novia" required>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-2 my-2 mx-5">
                                    <div class="input-group col-md-9">
                                        <input type="text" id="reg_matri_padresnovio" class="form-control  " placeholder="Padres Novio" required>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-2 my-2 mx-5">
                                    <div class="input-group col-md-9">
                                        <input type="text" id="reg_matri_padresnovia" class="form-control  " placeholder="Padres Novia" required>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-2 my-2 mx-5">
                                    <div class="input-group col-md-9">
                                        <input type="text" id="reg_matri_testigouno" class="form-control  " placeholder="Testigo 1" required>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-2 my-2 mx-5">
                                    <div class="input-group col-md-9">
                                        <input type="text" id="reg_matri_testigodos" class="form-control  " placeholder="Testigo 2" required>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-2 my-2 mx-5">
                                    <div class="col-md-9">
                                        <input type="text" id="reg_matri_infobautisonovio" class="form-control  " placeholder="Bautismo (libro y folio) Novio" required>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-2 my-2 mx-5">
                                    <div class="col-md-9">
                                        <label for="inputState" class="form-label">Fecha de bautiso novio</label>
                                        <input type="Date" id="reg_matri_infobautisonovio_fecha" class="form-control  " placeholder="" required>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-2 my-2 mx-5">
                                    <div class="col-md-9">
                                        <input type="text" id="reg_matri_infobautisonovia" class="form-control  " placeholder="Bautismo (libro y folio) Novia" required>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-2 my-2 mx-5">
                                    <div class="col-md-9">
                                        <label for="inputState" class="form-label">Fecha de bautiso novia</label>
                                        <input type="Date" id="reg_matri_infobautisonovia_fecha" class="form-control  " placeholder="" required>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-2 my-2 mx-5">
                                    <div class="col-md-9">
                                        <input type="text" id="reg_matri_ministro" class="form-control  " placeholder="Ministro" required>
                                    </div>
                                </div>                                 
                               <h6 class="mx-5">------------------ Datos del registro ------------------</h6>
                                <div class="col-md-12 mb-2 my-2 mx-5">
                                    <div class="input-group col-md-9">
                                        <input type="text" id="reg_matri_libro" class="form-control  " placeholder="Libro" required>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-2 my-2 mx-5">
                                    <div class="input-group col-md-9">
                                        <input type="text" id="reg_matri_folio" class="form-control  " placeholder="Folio" required>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-2 my-2 mx-5">
                                    <div class="input-group col-md-9">
                                        <input type="text" id="reg_matri_numero_reg" class="form-control  " placeholder="Numero Registro" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class=" row no-guters">
                                ...
                                <div class=" col-md-10 mb-2">
                                        <button id="regagregarmatri" type="button"
