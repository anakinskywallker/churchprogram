            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-bar-ready topbar mb-4 static-top shadow">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Turnos pagos</h1>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            ...
                            <button type="submit" href="#agregarotro" onclick="actualizartabla()"class="btn btn-primary-green">Actualizar</button>
                            </div> 
                        </div>
                        
                        <div class="card-body">
                            <div  id="tabla_turnos_pagos" class="table-responsive">                                
                            </div>
                        </div>
                    </div>
                      <!-------------------------------------------------- Boton PDFs ------------------------------------------------>
