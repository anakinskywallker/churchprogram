...
<div class="modal fade" id="accionescitas" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered " role="document">
            <div class="modal-content ">
                <div class="modal-header">
                ...
                <div class="modal-body ">
                    <div class=" container-Agregar">
                        ...
                        <form class="was-validated">
                            ...
                            <div class="col-md-12 text-center"> <!-- Agregado: clase text-center -->
                                                    <button type="button"
                                                        class="mx-5 col-md-6 btn btn-secondary " onclick="preguntarSiNoEliminar('<?php echo $usuario?>')" data-toggle="dropdown"
                                                        aria-haspopup="true" aria-expanded="false" required>
                                                        Eliminar tramite 
                                                    </button> 
                                            </div> 
...
<div class="modal fade" id="accionesotros" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered " role="document">
            <div class="modal-content ">
                <div class="modal-header">
                ...
                <div class="modal-body ">
                    <div class=" container-Agregar">
                        ...
                        <form class="was-validated">
                            ...
                            <div class="col-md-12 text-center"> <!-- Agregado: clase text-center -->
                                                    <button type="button"
                                                        class="mx-5 col-md-6 btn btn-secondary " onclick="preguntarSiNoEliminar('<?php echo $nombre_usuario?>')" data-toggle="dropdown"
                                                        aria-haspopup="true" aria-expanded="false" required>
                                                        Eliminar tramite 
                                                    </button> 
                                            </div> 
