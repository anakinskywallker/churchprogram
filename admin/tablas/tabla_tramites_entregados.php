...
$sql="SELECT tramite.*, ips.IPS_NOMBRE
      ...
      WHERE tramite.GS_TURNO = '$id_turno' AND tramite.GS_ESTADO = '8';";
                                        ...
                                        ?>
                                           ...
                                           <td>
                                            ...
                                            elseif($ver[2]==3){echo 'Medicamentos'; }
                                                ...
                                                if (empty($ver[22])) { echo 'Otros'; } else { echo '<a href="../admin/examenespdf/'.$ver[22].'" target="_blank"> <button data-target="#entregarmodal" type="button" class="btn btn-primary btn-sm">Otro</button> </a>'; }
                                            }?>
                                            </td> 
