...
$sql="SELECT tramite.*, ips.IPS_NOMBRE
      ...
      WHERE tramite.GS_TURNO = '$id_turno' AND (tramite.GS_ESTADO = '1' OR tramite.GS_ESTADO = '2' OR tramite.GS_ESTADO = '3' OR tramite.GS_ESTADO = '4' OR tramite.GS_ESTADO = '7' OR tramite.GS_ESTADO = '9');";
...
<table class="table table-bordered" id="dataTable2" width="100%" cellspacing="0">
    ...
    <thead>
                                    ...
                                    <tbody>
                                        ...
                                        ?></td>
                                        <?php if($ver[2]==1){
                                          echo '<td> <button  data-toggle="modal"  data-target="#accionescitas" onclick="agregaform('.$ver[0].')" type="button" class="btn btn-secondary btn-sm">Acciones</button></td>';
                                        }else{
                                          echo '<td> <button  data-toggle="modal"  data-target="#accionesotros" onclick="agregaform('.$ver[0].')" type="button" class="btn btn-secondary btn-sm">Acciones</button></td>';
                                        }
                                        ?>
