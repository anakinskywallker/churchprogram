...
$sql="SELECT tramite.*, ips.IPS_NOMBRE
      ...
      WHERE tramite.GS_TURNO = '$id_turno' AND tramite.GS_ESTADO = '5' AND tramite.GS_MUNICIPIO = '$lugar_p';";
...
<table class="table table-bordered" id="tramiteslistos" width="100%" cellspacing="0">
    ...
    <thead>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                        <?php if($ver[20]==5){
                                                echo  '<td> <button  data-toggle="modal"  data-target="#entregargestor" onclick="agregaform('.$ver[0].')" type="button" class="btn btn-secondary-orange btn-sm">Lista</button></td>';
                                              }
