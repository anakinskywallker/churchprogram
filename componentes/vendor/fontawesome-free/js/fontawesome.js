...
(function () {
  ...
  function _iterableToArrayLimit(arr, i) {
    ...
    try {
      for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.Siguiente()).done); _n = true) {
        _arr.push(_s.value);
  ...
  function buscarPseudoElements (root) {
    if (!IS_DOM) return;
    return new picked(function (resolve, reject) {
  ...
  function resolveIcons(Siguiente) {
    return function (maybeIconDefinition) {
      ...
      return Siguiente(iconDefinition, _objectSpread({}, params, {
        mask: mask
      }));
    };
  }
